      ...
      <div>
        ...
        <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <h2 className="text-md text-gray-500">
            Give a Hiremate mock interview in just 3 simple easy steps
          </h2>
         ...
         hover:border-pink-500/10 hover:shadow-pink-500/10 cursor-default"
            ...
            >
              ...
              <GiBrain className="h-8 w-8 text-indigo-700" />
                ...
                Create a Hiremate mock interview with AI
              </h2>

              <p className="mt-1 text-sm text-gray-400">
                You can create Hiremate mock interviews with AI, by providing your job
